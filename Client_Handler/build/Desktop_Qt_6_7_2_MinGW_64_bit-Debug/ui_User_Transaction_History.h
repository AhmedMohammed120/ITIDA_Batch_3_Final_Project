...
public:
    ...
    void setupUi(QWidget *User_Transaction_History)
    {
        ...
        User_Transaction_History->resize(1150, 820);
        QIcon icon;
        ...
        User_Transaction_History->setWindowIcon(icon);
        Sign_In_Label = new QLabel(User_Transaction_History);
        ...
        Back_PB->setGeometry(QRect(350, 650, 500, 121));
...
"border: 2px solid black; /* Optional: adds a visible border around the button */"));
        ...
        label_3->setGeometry(QRect(320, 30, 551, 61));
...
""));
        ...
        Transaction_History_LW->setGeometry(QRect(20, 120, 1111, 511));
...
"border: 2px solid black; /* Optional: adds a visible border around the button */"));
    ...
    {
        User_Transaction_History->setWindowTitle(QCoreApplication::translate("User_Transaction_History", "User - View Transaction History", nullptr));
        ...
        label_3->setText(QCoreApplication::translate("User_Transaction_History", "View Transaction History", nullptr));
    } // retranslateUi
