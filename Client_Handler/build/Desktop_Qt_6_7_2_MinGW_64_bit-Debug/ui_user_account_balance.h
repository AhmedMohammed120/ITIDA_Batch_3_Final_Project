...
public:
    ...
    void setupUi(QWidget *User_Account_Balance)
    {
        ...
        User_Account_Balance->resize(1150, 820);
        QIcon icon;
        ...
        User_Account_Balance->setWindowIcon(icon);
        Sign_In_Label = new QLabel(User_Account_Balance);
        ...
        Back->setGeometry(QRect(330, 660, 500, 100));
...
"border: 2px solid black; /* Optional: adds a visible border around the button */"));
        ...
        label_3->setGeometry(QRect(360, 50, 481, 61));
...
""));
        ...
        layoutWidget->setGeometry(QRect(70, 140, 961, 60));
...
"font: 3000 20pt \"Segoe Script\";"));
        ...
        Account_Balance_LE->setStyleSheet(QString::fromUtf8("border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));\n"
"font: 700 20pt \"Segoe Script\";\n"
"color: qconicalgradient(cx:0.058, cy:0.636, angle:0, stop:0 rgba(91, 80, 0, 255), stop:0.16 rgba(136, 106, 22, 255), stop:0.168269 rgba(235, 219, 102, 255), stop:0.225 rgba(128, 105, 15, 255), stop:0.285 rgba(204, 181, 74, 255), stop:0.415 rgba(245, 236, 112, 255), stop:0.52 rgba(209, 190, 76, 255), stop:0.57 rgba(187, 156, 51, 255), stop:0.695 rgba(202, 174, 68, 255), stop:0.75 rgba(218, 202, 86, 255), stop:0.815 rgba(208, 187, 73, 255), stop:0.88 rgba(187, 156, 51, 255), stop:0.935 rgba(137, 108, 26, 255), stop:0.990385 rgba(119, 98, 14, 255), stop:1 rgba(35, 40, 3, 255));\n"
"\n"
"\n"
...
"border: 2px solid black; /* Optional: adds a visible border around the button */"));
    ...
    {
        User_Account_Balance->setWindowTitle(QCoreApplication::translate("User_Account_Balance", "User - View Account Balance", nullptr));
        Sign_In_Label->setText(QString());
        Back->setText(QCoreApplication::translate("User_Account_Balance", "Back to Main Page", nullptr));
        label_3->setText(QCoreApplication::translate("User_Account_Balance", "View Account Balance", nullptr));
