...
"font: 900 12pt \"Segoe UI\";"));
        ...
        L_1 = new QLabel(Sign_In_GB);
        L_1->setObjectName("L_1");
        L_1->setGeometry(QRect(260, 320, 371, 121));
        L_1->setStyleSheet(QString::fromUtf8("border-image: url(:/812.png);"));
        L_1->setPixmap(QPixmap(QString::fromUtf8(":/812.png")));
        L_1->setScaledContents(true);
        widget = new QWidget(Sign_In_GB);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(0, 50, 406, 87));
