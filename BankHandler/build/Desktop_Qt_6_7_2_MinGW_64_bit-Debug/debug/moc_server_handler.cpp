/****************************************************************************
** Meta object code from reading C++ file 'server_handler.h'
**
...
#error "The header file 'server_handler.h' doesn't include <QObject>."
...
void ServerHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->Handle_Data_Request((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ServerHandler::Handle_Data_Request; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ServerHandler::Handle_Data_Request(QString _t1)
{
